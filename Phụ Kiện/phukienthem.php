...
<script language="javascript">
	function insertpk()
	{
		...
		var txthinhminhhoa=document.getElementById("txthinhminhhoa");
		var hinhminhhoa=document.getElementById("hinhminhhoa");
		if(txthinhminhhoa.value.length=="")
		 {
		   	txthinhminhhoa.style.color="#FF0000";
		   	hinhminhhoa.style.color="#FF0000";
		   	hinhminhhoa.innerHTML="Vui lòng nhập hình ảnh";
		   	txthinhminhhoa.focus();
		   	return false;
		 }
		else 
		 {
			txthinhminhhoa.style.color="";
			txthinhminhhoa.innerHTML="";
		 }
...
<form action="phukienthemxl.php" method="post"  name="frmCapnhat" name="frmaddproduct">
<table cellspacing="0" border="1">
<tr>
		<th>Mã Phụ Kiện</th>
		<th><input type="text" name="mapk" style="width:80%" readonly="readonly" /></th>
	</tr>
		<tr>
		<th>Tên Phụ Kiện</th>
		<th><input type="text" name="tenpk" style="width:80%" id="txttenpk" /><div id="tenpk"></div></th>
	</tr>
	<tr>
		<th>Mô Tả</th>
		<th>
	...
	<tr>
		<th>Hình Ảnh</th>
		<th><input name="txthinhminhhoa" type="text" id="txthinhminhhoa"><div id="hinhminhhoa"></div>
  			<input type="button" name="Button" value="Upload" onClick="window.open('../upload/Upload.php','','width=1500,height=100, status=true')"></th>
	</tr>
	<tr>
		<th>Số Lượng</th>
		<th><input type="text" name="soluong" style="width:80%" id="txtsl" /><div id="sl"></div></th>
	</tr>
	<tr>
		<th>Giá Phụ Kiện</th>
		<th><input type="text" name="giapk" style="width:80%" id="txtgpk" /><div id="gpk"></div></th>
	</tr>
	<tr>
		<th>Mã Loại</th>
		<th><input type="text" name="maloai" style="width:80%" id="txtml" /><div id="ml"></div></th>
	</tr>
	<tr>
		<th></th>
		<th><input type="submit" value="insert" style="width:80%" onclick="return insertpk()"/></th>
	</tr>
</table>
</form>
</body>
