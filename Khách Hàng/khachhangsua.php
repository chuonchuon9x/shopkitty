...
$query="select * from tblkhachhang where MaKH='$MaKH'";
...
?>
<form action="khachhangsuaxl.php" method="post">
<table cellspacing="0" border="1">
<tr>
		<th>Mã Khách Hàng</th>
		<th><input type="text" name="txtkhachhang" style="width:80%" value="<?php echo $MaKH ?>" readonly="readonly" /></th>
	</tr>
		<tr>
		<th>Họ tên Khách Hàng</th>
		<th><input type="text" name="txtten" value="<?php echo $HoTenKH ?>" style="width:80%" id="txttenkh" /><div id="tenkh"></div></th>
	</tr>
	<tr>
		<th>Ngày sinh </th>
		<th><input name="txtDate" type="text" id="txtDate" style="width:60%" /> <div id="date"></div>
  			<input type="button" name="Button" value="Date" onclick="showCalendar('txtDate')"  value="<?php echo $ns ?>" style="width:20%"/></th>
	</tr>
	<tr>
		<th>Số Điện Thoại</th>
		<th><input type="text" name="txtsdt" style="width:80%" value="<?php echo $sdt ?>" id="txtsdt" /><div id="sdt"></div></th>
	</tr>
	<tr>
		<th>Email</th>
		<th><input type="text" name="txtemail" style="width:80%" value="<?php echo $email ?>" id="txtemail" /><div id="email"></div></th>
	</tr>
	<tr>
		<th>Tài Khoản</th>
		<th><input type="text" name="txtuser" style="width:80%" value="<?php echo $username ?>" id="txttk" /><div id="tk"></div></th>
	</tr>
	<tr>
		<th>Mật Khẩu</th>
		<th><input type="password" name="txtpass" style="width:80%"value="<?php echo $password ?>" id="txtmk" /><div id="mk"></div></th>
	</tr>
	<tr>
		<th>Địa Chỉ</th>
		<th><input type="text" name="txtdiachi" style="width:80%" value="<?php echo $DiaChi ?>" id="txtdc" /><div id="dc"></div></th>
	</tr>
	<tr>	
		<th>Giới Tính</th>
		<th><input type="radio" name="txtgt" value="0"/>Nam
			<input type="radio" name="txtgt" value="1" />Nữ</th>
	</tr>
	<tr>
		<th></th>
		<th><input type="submit" value="update" style="width:50%; " onclick="return updatkh()"/></th>
	</tr>
</table>
</form>
</body>
