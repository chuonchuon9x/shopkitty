...
?>
    <tr>
		...
		<td><?php if($row["gt"]=='0'){
					...
					?></td>
        <td><a href="khachhangsua.php?MaKH=<?php echo $row["MaKH"]; ?>" >Sửa</a></td>
        <td><a href="khachhangxoa.php?MaKH=<?php echo $row["MaKH"]; ?>" onClick="return confirm('Bạn có muốn xóa')">Xóa</a></td>
    </tr>
<?php 
}
?>
</table>
<a href="khachhangthem.php">Thêm</a>
<?php 
