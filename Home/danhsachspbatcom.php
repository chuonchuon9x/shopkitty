...
<?php
	...
	//lay toan bo san pham ve
		...
		$resultTongSp=mysqli_query($con,"select count(*) as SoLuong from tblphukien where tblphukien.MaLoai=13");
		$rowTongSp=mysqli_fetch_array($resultTongSp);
		$tongSp=$rowTongSp["SoLuong"];
		//tong so trang
		...
		//b2.1: viet cau query
		$sql="select * from tblphukien  where tblphukien.MaLoai=13 limit $start,$soSanPham1Trang";
		//b2.2:chay cau query
