...
<body background="../images/admin.jpg">
	...
	//lay toan bo san pham ve
		...
		$resultTongSp=mysqli_query($con,"select count(*) as SoLuongPK from tblphukien where tblphukien.MaLoai=1");
		...
		//b2.1: viet cau query
		$sql="select * from tblphukien  where tblphukien.MaLoai=1 limit $start,$soSanPham1Trang";
		//b2.2:chay cau query
