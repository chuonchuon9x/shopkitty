...
<?php
	...
	//lay toan bo san pham ve
		...
		$resultTongSp=mysqli_query($con,"select count(*) as SoLuongPK from tblphukien where tblphukien.MaLoai=23");
		...
		//b2.1: viet cau query
		$sql="select * from tblphukien  where tblphukien.MaLoai=23 limit $start,$soSanPham1Trang";
		//b2.2:chay cau query
