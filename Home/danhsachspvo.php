...
<body background="../images/admin.jpg">
	...
	//lay toan bo san pham ve
		...
		$resultTongSp=mysqli_query($con,"select count(*) as SoLuongPK from tblphukien where tblphukien.MaLoai=4");
		...
		//b2.1: viet cau query
		$sql="select * from tblphukien  where tblphukien.MaLoai=4 limit $start,$soSanPham1Trang";
		//b2.2:chay cau query
